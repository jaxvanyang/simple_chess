...
public class GrabBlock extends Block {
    public static final TagKey<Block> PIECE_BLOCK = TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(
            "simple_chess", "chess_piece"));
    public static final TagKey<Item> PIECE_ITEM = TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(
            "simple_chess", "chess_piece"));
